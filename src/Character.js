...
class Character {
    constructor(name) {
        this.name = name;
        this.name = name;
        this._dexterity = (0, utils_1.default)(1, 11);
        this._defense = 0;
        ...
        this._lifePoints = 0;
        this._energy = { amount: (0, utils_1.default)(1, 11),
    ...
    levelUp() {
        this._strength += (0, utils_1.default)(1, 11);
        this._defense += (0, utils_1.default)(1, 11);
        this._lifePoints += (0, utils_1.default)(1, 11);
        this._dexterity += (0, utils_1.default)(1, 11);
